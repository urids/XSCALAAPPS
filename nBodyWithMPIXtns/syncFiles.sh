...
rsync /home/uriel/Dev/mpiApps/extnsApps/nBodyWithMPIXtns/scheduleFile.cfg uriel@$i:/home/uriel/Dev/mpiApps/extnsApps/nBodyWithMPIXtns/
#copy the Data
